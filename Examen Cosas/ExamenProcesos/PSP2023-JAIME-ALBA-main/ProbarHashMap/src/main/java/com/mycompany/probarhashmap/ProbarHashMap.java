...
//        HashMap<String,Integer> personas = new HashMap<>();
        ...
        // Para guardar datos:
        personas.put("Juan", 55);
        personas.put("XLuis", 33);
        personas.put("APaquito", 44);
        personas.put("aXLuis", 33);
        personas.put("aZJuan", 55);
        personas.put("aAPaquito", 44);
        ...
        for (Entry<String, Integer> e : personas.entrySet()) {
...
//        persOrd.putAll(personas);
        ...
        personasLista.sort(Entry.comparingByKey());
