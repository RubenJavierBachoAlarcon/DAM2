...
package com.mycompany.ejerciciossockettodos;
...
public class ServidorDNSConcurrente 
{
    ...
    public static void main(String[] args) throws IOException 
    {
        ...
        while (true) 
        {
            ...
            ClientRequestHandler2 clientHandler = new ClientRequestHandler2(socket, paqueteRecibido, dnsMap);
...
class ClientRequestHandler2 implements Runnable 
{
    ...
    public ClientRequestHandler2(DatagramSocket socket, DatagramPacket paqueteRecibido, Map<String, String> dnsMap) {
        this.socket = socket;
    ...
    public void run() 
    {
        ...
        try 
        {
            ...
            Logger.getLogger(ClientRequestHandler2.class.getName()).log(Level.SEVERE, null, ex);
        }
