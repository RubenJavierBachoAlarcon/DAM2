...
public class ClienteDNS {
  ...
  public static void main(String[] args) {
            ...
            BufferedReader brStdIn = new BufferedReader(isrStdIn)) 
    {
      ...
      System.out.println("Introduce nombre DNS a buscar. Línea vacía para terminar.");
      ...
      while ((lineaLeida = brStdIn.readLine()) != null && lineaLeida.length() > 0)   //Mientras haya introducido una linea
      {
        ...
        System.out.println("El la IP para el dominio:"+lineaLeida+ " es: "+ respuesta);
        
        System.out.print("SigNombreDNS>");
